#ifndef TESTEDGECONTRACTILITY_HPP_
#define TESTEDGECONTRACTILITY_HPP_
...
public:
    ...
    void TestEdgeContractility()
    {
        ...
        // Boundary adhesion
        double min_cell_boundary_adhesion = 0.0;
            ...
            */
            {
                ...
                */
                ...
                catch (Exception& e)
                {
                    ...
                    WARNING("Local purse string simulation didnt run" << paramAsString.str() << ".");
...
#endif /* TESTEDGECONTRACTILITY_HPP_ */