#ifndef TESTLOCALCRAWLING_HPP_
#define TESTLOCALCRAWLING_HPP_
            ...
            // void xTestWoundNormalForce()
            {
                ...
                */
                ...
                catch (Exception& e)
                {
                    ...
                    WARNING("Local crawling simulation didnt run" << paramAsString.str() << ".");
